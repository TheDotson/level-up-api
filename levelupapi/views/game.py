...
class GamesViewSet(ViewSet):
    ...
    def create(self, request):
        ...
        # Try to save thenew game to the database, then 
        ...
        # client that something was wrong with it's request data
    ...
    def destroy(self, request, pk=None):
        ...
        Returns: 
            Response -- 200, 204, or 500 status code
        """
        try:
            game = Game.objects.get(pk=pk)
            self.check_object_permissions(request, game)
    ...
    def list(self, request):
        ...
        # Suppor4t filtering games by type
        #      http://localhost:800/games?type=1
        #
